...
| Spécifications | [Cahier des charges](../Cahier-des-charges-Gestion-Missions-Parc.md) | Expression du besoin (référence métier, v9) |
...
| Réalisation | (code) `src/`, migrations `db/migration/V1..V8` | Application Spring Boot |
